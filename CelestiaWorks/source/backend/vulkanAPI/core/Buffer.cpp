...
void celestia::buffer::updateBuffer(AllocatedBuffer& dstBuffer, VkDeviceSize dstOffset, VkDeviceSize dataSize, const void* vertexData)
{
...
{
    AllocatedBuffer stagingBuffer = buffer::createBuffer(bufferSize,
