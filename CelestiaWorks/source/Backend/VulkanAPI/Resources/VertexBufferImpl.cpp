...
static VkBufferUsageFlags CelestiaUsageToVk(celestia::Usage usage)
{
	switch(usage)
	{
	case celestia::Usage::STATIC: return VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
	case celestia::Usage::STATIC_INDEXED: return VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
	case celestia::Usage::STREAM: return VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;
	case celestia::Usage::STREAM_INDEXED:
		return VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;
	default: throw std::invalid_argument("Unsupported Usage");
	}
}
