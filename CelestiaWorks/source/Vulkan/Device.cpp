...
VkPhysicalDevice celestia::Device::getPhysicalDevice()
{
	return physicalDevice;
}

VkDevice celestia::Device::getDevice()
{
	return device;
}
...
std::vector<const char*> celestia::Device::getExtensions()
{
...
void celestia::Device::getFramebufferSize(int* width, int* height)
{
